...
public class ${camel-case-source-name}ConverterTest extends ItemsTestCase
{
    Model model = Model.getInstanceByName("genomic");
    ${camel-case-source-name}Converter converter;
    MockItemWriter itemWriter;

    public ${camel-case-source-name}ConverterTest(String arg) {
        super(arg);
    }
